...
export default function WorkHistory() {
  return (
    <div>
      ...
      <p>
        For the past few months I have been apart of a bootcamp; learning full stack development. To be completely honest with you this experience has been stressful to say the least. I went from knowing nothing about coding and I mean nothing at all. To being able to understand html, css, javascript and much more. Regular expression; regex is a word that means something to me now I can use it when I want to know. One thing that may seem minor to you but has been a funny odd thing to realize about myself is I can type alot faster now. Let me refocus; I know how to use Express; Sequelize, and one of the thing I learned I find extremely intresting is knowing how to create my own api. The potential from that knowledge that I can think of being able to create a system that can be used in work places. I know about fetching information from other api's. Using CRUD; I really got to learn alot over these past few months and I hope to get the chance to expand my knowledge and sharpen my skills.

        Here is a link to my github page: <a href = "https://github.com/bs-driven"></a>
      </p>
    </div>
  );
}
